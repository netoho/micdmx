class ProjectTypesController < ApplicationController
  ...
  def create
    ...
    @project_type.id = ProjectType.all.length + 1

    respond_to do |format|
      if @project_type.save
        format.html { redirect_to @project_type, notice: 'Project type1 was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @project_type.update(project_type_params)
        format.html { redirect_to @project_type, notice: 'Project type1 was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_types_url, notice: 'Project type1 was successfully destroyed.' }
  ...
  private
    ...
    def project_type_params
      params.require(:project_type).permit(:project_type, :status_id, {content_type_ids: []})
    end
end
