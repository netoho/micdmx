...
ActiveRecord::Schema.define(version: 20150308164251) do
  ...
  create_table "meses", primary_key: "nombre_corto", force: :cascade do |t|
  ...
  create_table "project_type1s", force: :cascade do |t|
    t.string   "type"
    t.integer  "status_id"
  ...
  add_index "project_type1s", ["status_id"], name: "index_project_type1s_on_status_id", using: :btree
  ...
  add_foreign_key "expert_reviews", "statuses", name: "expert_reviews_status_id_fkey"
  ...
  add_foreign_key "expert_users", "statuses", name: "expert_users_status_id_fkey"
  ...
  add_foreign_key "project_type1s", "statuses"
  add_foreign_key "project_types", "statuses", name: "project_types_status_id_fkey"
  add_foreign_key "projects", "project_types", column: "project_types_id", name: "projects_project_types_id_fkey"
  add_foreign_key "projects", "statuses", column: "invalidate_type_id", name: "projects_invalidate_type_id_fkey"
  add_foreign_key "projects", "statuses", column: "validation_status_id", name: "projects_validation_status_id_fkey"
  ...
  add_foreign_key "users", "statuses", name: "users_status_id_fkey"
